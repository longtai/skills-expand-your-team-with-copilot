...
def get_activities(
    ...
    - difficulty: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'All' for activities without specified difficulty)
    """
    ...
    if difficulty:
        if difficulty == "All":
            # "All" means activities without a specified difficulty
